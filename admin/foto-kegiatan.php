        ...
        <div class="container">
            <form action="" method="" name="">
                <table class="w-100 mt-4 mb-2">
                    <tr>
                        <td class="w-75">
                            <a href="tambah-kegiatan.php" class="btn btn-primary">Tambah Foto Kegiatan</a>
                        </td>
                        <td class="d-flex">
                ...
                <table class="table table-bordered table-striped table-responsive w-100">
                    ...
                    <tr>
                        ...
                        <td class="text-center">Data dari db</td>
                        <td class="">Lorem dolor sit amet consectetur, adipisicing elit.</td>
                        <td class="text-center">Data dari db</td>
                        <td class="text-center">
                            <a href="update-kegiatan.php" class="btn btn-warning ms-3 me-3">Edit</a> |   <a href="delete-kegiatan.php" class="btn btn-danger ms-3 me-3">Hapus</a>
                        </td>
                    </tr>
                </table>
            </form>
